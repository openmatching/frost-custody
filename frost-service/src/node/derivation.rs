...
pub fn dkg_part1_with_provider(
    ...
    let mut rng = key_provider.derive_rng(passphrase, "")?;
...
pub fn dkg_part1_ecdsa_with_provider(
    key_provider: &dyn MasterKeyProvider,
    passphrase: &str,
    node_index: u16,
    max_signers: u16,
    ...
    let mut rng = key_provider.derive_rng(passphrase, "ecdsa")?;
...
pub fn dkg_part1_ed25519_with_provider(
    key_provider: &dyn MasterKeyProvider,
    passphrase: &str,
    node_index: u16,
    max_signers: u16,
    ...
    let mut rng = key_provider.derive_rng(passphrase, "ed25519")?;
