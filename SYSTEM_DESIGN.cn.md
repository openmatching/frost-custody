...
| ---------------- | --------------- | -------------------- |
| 配置文件（明文） | 免费            | 开发环境             |
| **HSM/PKCS#11**  | **$55-5K/节点** | **生产环境（默认）** |

PKCS#11 支持默认启用。支持 YubiKey ($55)、Thales、AWS CloudHSM 等任何 PKCS#11 设备。

配置详情：`frost-service/CONFIG_HSM.md` | 测试：`cargo xtask test-dkg --hsm`
...
**灵活性：**
- 支持任意 m-of-n 配置（从 2-of-3 到 18-of-24 及以上）
- n 值越大，系统可用性越高
- m 值越大，安全性越高（容错能力相应降低）
